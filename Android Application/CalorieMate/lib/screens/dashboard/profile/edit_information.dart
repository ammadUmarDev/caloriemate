                            ...
                            ButtonErims(
                              onTap:
                                ...
                                if (btnState == ButtonState.Idle) {
                                  ...
                                  await retChangeTargettedWeight.then((value) =>
                                      retChangeTargettedWeightCheck = value);
                          ...
                          children: <Widget>[
                            ...
                            ButtonErims(
                              onTap:
                                ...
                                if (btnState == ButtonState.Idle) {
                                  startLoading();
                                  var retChangeHeight = changeHeight(userObj,
                                      int.parse(heightFt), int.parse(heightIn));
                                  bool retChangeHeightCheck;
                                  await retChangeHeight.then(
                                      (value) => retChangeHeightCheck = value);
