...
class _DiaryScreenState extends State<DiaryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // if (date.day == dateToday.day - 1) {
    //   dateToDisplay = "Yesterday";
    // }

    if (date.day == dateToday.subtract(Duration(days: 1)).day) {
      dateToDisplay = "Yesterday";
    }
    ...
    if (date.day == dateToday.add(Duration(days: 1)).day) {
      dateToDisplay = "Tomorrow";
    }
          ...
          builder: (BuildContext context, AsyncSnapshot snapshot) {
            if (snapshot.hasData) {
              ...
              breakfastDiary = diaryList
                  ...
                  .toList();
              lunchDiary = diaryList
                  .where((element) => element.type == "lunch")
                  .toList();
              dinnerDiary = diaryList
                  .where((element) => element.type == "dinner")
                  .toList();
              snacksDiary = diaryList
                  .where((element) => element.type == "snacks")
                  .toList();

              calsConsumed = countCalories(diaryList);
              calsConsumedDouble = double.parse(calsConsumed);

              calsBreakfast = countCalories(breakfastDiary);
              calsLunch = countCalories(lunchDiary);
              calsDinner = countCalories(dinnerDiary);
              calsSnacks = countCalories(snacksDiary);
            }
                                      ...
                                      Column(
                                        ...
                                        children: <Widget>[
                                          CircularPercentIndicator(
                                            ...
                                            progressColor: (calsConsumedDouble /
                                                        goalInt) >=
                                                    1
                                                ? kActiveCardColour
                                                : kYellow,
                          ...
                          Padding(
                            ...
                            child: Column(
                              children: <Widget>[
                                Container(
                                  margin:
                                      EdgeInsets.only(top: pageHeight * 0.02),
              ...
              buttons: [
                DialogButton(
                  ...
                  onPressed: () {
                    ...
                    Utils.showToast(message: "Item Deleted", success: false);
